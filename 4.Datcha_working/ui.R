                          ...
                          ')),
                            ...
                            sidebarLayout(
                              sidebarPanel(
                                ...
                                uiOutput("id_validation_msg_1"), # New output for Dataset 1 ID validation
                                uiOutput("date_validation_msg_1"), # Date validation message for Dataset 1 (optional, for consistency)
                                hr(),
                                fluidRow(
                                ...
                                uiOutput("id_validation_msg_2"), # New output for Dataset 2 ID validation
                                uiOutput("date_validation_msg_2"), # Date validation message for Dataset 2
